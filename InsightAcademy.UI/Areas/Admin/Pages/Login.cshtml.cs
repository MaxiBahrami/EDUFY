...
namespace InsightAcademy.UI.Areas.Admin.Pages
{
	public class LoginModel : PageModel
	{
		...
		public LoginModel(SignInManager<ApplicationUser> signInManager, ILogger<LoginModel> logger, IDNTCaptchaValidatorService validatorService, UserManager<ApplicationUser> userManager)
		{
