...
{
	public class JoinAsTeacherModel : PageModel
	{
		private readonly SignInManager<ApplicationUser> _signInManager;
		private readonly UserManager<ApplicationUser> _userManager;
		private readonly IUserStore<ApplicationUser> _userStore;
		private readonly IUserEmailStore<ApplicationUser> _emailStore;
		private readonly ILogger<JoinAsTeacherModel> _logger;
		private readonly IEmailSender _emailSender;
		private readonly FileUploader _fileUploader;
		private readonly ITutor _tutor;

		public JoinAsTeacherModel(
			IEmailSender emailSender,
			UserManager<ApplicationUser> userManager,
			IUserStore<ApplicationUser> userStore,
			SignInManager<ApplicationUser> signInManager,
			ILogger<JoinAsTeacherModel> logger,
			...
			if (ModelState.IsValid)
			{
				...
				if (result.Succeeded)
				{
					...
					if (rolestatus.Succeeded)
					{
						...
						Tutor profile = new Tutor() { ApplicationUserId = user.Id, FirstName = user.FirstName, LastName = user.LastName, Country = user.Country, City = user.City, HourlyRate = 0, Introduction = "", Tagline = "",IsVerified=true };
