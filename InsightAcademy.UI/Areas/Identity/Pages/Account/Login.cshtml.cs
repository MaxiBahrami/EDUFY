...
namespace InsightAcademy.UI.Areas.Identity.Pages.Account
{
    public class LoginModel : PageModel
    {
        ...
        public LoginModel(SignInManager<ApplicationUser> signInManager, ILogger<LoginModel> logger, IDNTCaptchaValidatorService validatorService, UserManager<ApplicationUser> userManager, IHubContext<PresenceHub> hubContext)
        {
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    //if (user.Status == true) //user account is block
                    //{
                    //    return Redirect("/Identity/Account/Lockout");
                    //}
                    await _hubContext.Clients.All.SendAsync("UserIsOnline", "");
