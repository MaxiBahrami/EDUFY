...
namespace InsightAcademy.UI.Areas.Identity.Pages.Account
{
    public class ForgotPasswordModel : PageModel
    {
        ...
        public ForgotPasswordModel(UserManager<ApplicationUser> userManager, IEmailSender emailSender, IEmailService applicationEmailSender)
        {
            _userManager = userManager;
            _emailSender = emailSender;
            _emailService = applicationEmailSender;
        }
        ...
        public async Task<IActionResult> OnPostAsync()
        {
            if (ModelState.IsValid)
            {
                ...
                await _emailService.ResetConfrimationEmail(
                    Input.Email,
