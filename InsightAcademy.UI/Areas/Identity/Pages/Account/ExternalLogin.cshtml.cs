    ...
    public class ExternalLoginModel : PageModel
    {
        ...
        public async Task<IActionResult> OnGetCallbackAsync(string returnUrl = null, string remoteError = null)
        {
            ...
            if (user == null)
            {
                ...
                {
                    return Redirect($"/Identity/Account/AdditionalInformation/{info.Principal.FindFirstValue(ClaimTypes.Email)}/{info.LoginProvider}/{info.ProviderKey}/{info.ProviderDisplayName}");
                }
            }
            else
            {
            ...
            //}
            //ModelState.AddModelError("", "Something Wrong! Please try again later");
            //return RedirectToPage("./Login", new { ReturnUrl = returnUrl });
        }
